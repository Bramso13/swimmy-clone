...
export default function SettingsPage() {
  ...
  const setHelpCardState = (element: HTMLElement, hovered: boolean) => {
    element.style.borderColor = hovered ? BRAND_BLUE : "#E5E7EB";
    element.style.backgroundColor = hovered ? BRAND_BLUE_SOFT : "white";
  };
  ...
  return (
    <>
      {/* Header Section - Bleu */}
      <div
        className="py-8 px-4 flex items-center justify-center min-h-[40vh] w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div 
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = BRAND_BLUE_HOVER;
              }}
              onMouseLeave={(e) => {
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {faqItems.map((q) => (
                <div key={q.slug} className="space-y-2">
                  <Link href={`/settings/faq/${q.slug}`} className="block font-semibold hover:underline" style={{ color: BRAND_BLUE }}>
                    {q.title}
                  </Link>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <Link
                ...
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
              ...
              <Link
                href="/settings/faq/annulation-reservation"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Annulation d'une réservation</p>
              </Link>

              {/* Paiements */}
              <Link
                href="/settings/faq/paiements"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Paiements</p>
              </Link>

              {/* Compte */}
              <Link
                href="/settings/faq/compte"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Compte</p>
              </Link>

              {/* Gestion d'une location */}
              <Link
                href="/settings/faq/gestion-location"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Gestion d'une location</p>
              </Link>

              {/* Sinistre, litige, caution */}
              <Link
                href="/settings/faq/sinistre-litige-caution"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Sinistre, litige, caution</p>
              </Link>

              {/* Assurance */}
              <Link
                href="/settings/faq/assurance"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Assurance</p>
              </Link>

              {/* Evaluations et commentaires */}
              <Link
                href="/settings/faq/evaluations-commentaires"
                className="bg-white border-2 rounded-lg p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-lg group"
                style={{ borderColor: "#E5E7EB" }}
                onMouseEnter={(e) => setHelpCardState(e.currentTarget as HTMLElement, true)}
                onMouseLeave={(e) => setHelpCardState(e.currentTarget as HTMLElement, false)}
              >
                ...
                <p className="font-medium" style={{ color: BRAND_BLUE }}>Evaluations et commentaires</p>
              </Link>
            </div>
          </div>
        </div>

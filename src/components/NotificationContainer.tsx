    ...
    <div className="fixed top-4 right-4 z-50 flex flex-col gap-2 max-w-md w-full">
      {notifications.map((notification) => {
        ...
        return (
          ...
          >
            <div className={`${styles.icon} flex-shrink-0 mt-0.5`}>{getIcon(notification.type)}</div>
            <div className="flex-1 min-w-0">
              <h4 className={`${styles.title} font-semibold text-sm`}>{notification.title}</h4>
              ...
              {notification.action && (
                <button
                  ...
                  className={`${styles.title} text-sm font-medium mt-2 hover:underline`}
                >
